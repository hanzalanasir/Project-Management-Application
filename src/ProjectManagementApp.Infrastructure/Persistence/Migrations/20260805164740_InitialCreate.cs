        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_projects_end_date_after_start_date", "end_date IS NULL OR end_date >= start_date");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_team_members_projects_project_id",
                        column: x => x.project_id,
                        principalTable: "projects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_team_members_users_added_by",
                        column: x => x.added_by,
                        principalTable: "users",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_team_members_added_by",
                table: "team_members",
                column: "added_by");

            migrationBuilder.CreateIndex(
                name: "ix_team_members_project_id",
                table: "team_members",
                column: "project_id");
